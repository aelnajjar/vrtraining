...
$query = "UPDATE users2 SET earthquake='".$_GET["earthquake"]."',ourgame='".$_GET["ourgame"]."' WHERE username='".$_GET["username"]."'";
//$query = "UPDATE users2 SET ourgame='".$_GET["ourgame"]."' WHERE username='".$_GET["username"]."'";
